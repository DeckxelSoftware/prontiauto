...
public class AbonoPrestamoResponseDao extends AbstractResponseDao {
    ...
    private PrestamoResponseDao idPrestamo;

    public AbonoPrestamoResponseDao() {
    }
    ...
    public PrestamoResponseDao getIdPrestamo() {
        return idPrestamo;
    }

    public void setIdPrestamo(PrestamoResponseDao idPrestamo) {
