...
public class TrabajadorResponseDao extends AbstractResponseDao {
	...
	private SupervisorResponseDao idSupervisor;
	private VendedorResponseDao idVendedor;
	private List<CargaFamiliarResponseDao> cargaFamiliarCollection;
	private List<HistorialLaboralResponseDao> historialLaboralCollection;
	private List<MemorandumResponseDao> memorandumCollection;
	private List<InformacionFinancieraResponseDao> informacionFinancieraCollection;
	private List<PrestamoResponseDao> prestamoCollection;
	private List<CargoVacacionResponseDao> cargoVacacionCollection;
	...
	private List<SriGastosResponseDao> sriGastosCollection;
	...
	public SupervisorResponseDao getIdSupervisor() {
		return idSupervisor;
	}

	public void setIdSupervisor(SupervisorResponseDao idSupervisor) {
		this.idSupervisor = idSupervisor;
	}

	public VendedorResponseDao getIdVendedor() {
		return idVendedor;
	}

	public void setIdVendedor(VendedorResponseDao idVendedor) {
		this.idVendedor = idVendedor;
	}

	public List<CargaFamiliarResponseDao> getCargaFamiliarCollection() {
		return cargaFamiliarCollection;
	}

	public void setCargaFamiliarCollection(List<CargaFamiliarResponseDao> cargaFamiliarCollection) {
	...
	public List<MemorandumResponseDao> getMemorandumCollection() {
		return memorandumCollection;
	}

	public void setMemorandumCollection(List<MemorandumResponseDao> memorandumCollection) {
		this.memorandumCollection = memorandumCollection;
	}

	public List<InformacionFinancieraResponseDao> getInformacionFinancieraCollection() {
		return informacionFinancieraCollection;
	}

	public void setInformacionFinancieraCollection(
			List<InformacionFinancieraResponseDao> informacionFinancieraCollection) {
		this.informacionFinancieraCollection = informacionFinancieraCollection;
	}

	public List<PrestamoResponseDao> getPrestamoCollection() {
		return prestamoCollection;
	}

	public void setPrestamoCollection(List<PrestamoResponseDao> prestamoCollection) {
		this.prestamoCollection = prestamoCollection;
	}

	public List<CargoVacacionResponseDao> getCargoVacacionCollection() {
		return cargoVacacionCollection;
	}

	public void setCargoVacacionCollection(List<CargoVacacionResponseDao> cargoVacacionCollection) {
	...
	public List<SriGastosResponseDao> getSriGastosCollection() {
		return this.sriGastosCollection;
	}

	public void setSriGastosCollection(List<SriGastosResponseDao> sriGastosCollection) {
