...
public class OrdenCompraRequestDao extends AbstractRequestDao {
    ...
    private ArticuloRequestDao articulo;

    public OrdenCompraRequestDao() {
    }
    ...
    public ArticuloRequestDao getArticulo() {
        return articulo;
    }

    public void setArticulo(ArticuloRequestDao articulo) {
