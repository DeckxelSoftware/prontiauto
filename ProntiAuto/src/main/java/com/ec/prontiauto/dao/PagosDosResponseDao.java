...
public class PagosDosResponseDao extends AbstractResponseDao {
    ...
    public PagosUnoResponseDao getIdPagosUno() {
        return idPagosUno;
    }

    public void setIdPagosUno(PagosUnoResponseDao idPagosUno) {
