...
import com.ec.prontiauto.repositoryImpl.RegionRepositoryImpl;

import io.swagger.annotations.Api;

@RestController
@RequestMapping("/api/region")
@Api(tags = "Region", description = "Gestion de Region")
@CrossOrigin(origins = "*", methods= {RequestMethod.GET,RequestMethod.POST,RequestMethod.PUT})
public class RegionController extends AbstractController<Region, RegionRequestDao, RegionResponseDao, Integer> {
    ...
    @Override
    public RegionResponseDao devolverRespuestaDao(Region entity) {
        return RegionMapper.setEntityToDaoResponse.apply(entity);
    }

    @Override
    @Transactional
    public Region devolverRespuestaUpdate(Region entity, Integer id) {
        Region antiguo = (Region) genericMethods.findById("Region", entityManager, id);
        if (antiguo != null) {
    ...
    @Override
    public Region setDaoRequestToEntity(RegionRequestDao dao) {
        return RegionMapper.setDaoRequestToEntity.apply(dao);
    }
