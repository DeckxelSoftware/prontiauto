...
import com.ec.prontiauto.repositoryImpl.CargoRepositoryImpl;
...
// })
@Api(tags = "Cargo", description = "Gestion de Cargo")
@CrossOrigin(origins = "*", methods= {RequestMethod.GET,RequestMethod.POST,RequestMethod.PUT})
public class CargoController extends
		AbstractController<Cargo, CargoRequestDao, CargoResponseDao, Integer> {
	...
	@Override
	public CargoResponseDao devolverRespuestaDao(Cargo entity) {
		return CargoMapper.setEntityToDaoResponse.apply(entity);
	}

	@Override
	@Transactional
	public Cargo devolverRespuestaUpdate(Cargo entity, Integer id) {
		Cargo antiguo = (Cargo) genericMethods.findById("Cargo",
				entityManager, id);
		if (antiguo != null) {
	...
	@Override
	public Cargo setDaoRequestToEntity(CargoRequestDao dao) {
		return CargoMapper.setDaoRequestToEntity.apply(dao);
	}
