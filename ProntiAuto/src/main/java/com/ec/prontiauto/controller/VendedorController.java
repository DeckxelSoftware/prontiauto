...
import com.ec.prontiauto.repositoryImpl.VendedorRepositoryImpl;

import io.swagger.annotations.Api;

@RestController
@RequestMapping("/api/vendedor")
@Api(tags = "Vendedor", description = "Gestion de Vendedor")
@CrossOrigin(origins = "*", methods= {RequestMethod.GET,RequestMethod.POST,RequestMethod.PUT})
public class VendedorController extends
		AbstractController<Vendedor, VendedorRequestDao, VendedorResponseDao, Integer> {
	...
	@Override
	public VendedorResponseDao devolverRespuestaDao(Vendedor entity) {
		return VendedorMapper.setEntityToDaoResponse.apply(entity);
	}

	@Override
	@Transactional
	public Vendedor devolverRespuestaUpdate(Vendedor entity, Integer id) {
		Vendedor antiguo = (Vendedor) genericMethods.findById("Vendedor",
				entityManager, id);
		if (antiguo != null) {
	...
	@Override
	public Vendedor setDaoRequestToEntity(VendedorRequestDao dao) {
		return VendedorMapper.setDaoRequestToEntity.apply(dao);
	}

	@RequestMapping(value = "", method = RequestMethod.GET)
	public ResponseEntity<?> findBySearchAndUpdate(String busqueda,

			String idTrabajadorModalidadContrato,
